...
import { PosteRecruitmentDashboard } from './PosteRecruitmentDashboard';
      ...
      <DialogContent className="max-w-4xl max-h-[90vh]">
        ...
        <Tabs defaultValue="details" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="recruitment">Suivi recrutement</TabsTrigger>
          </TabsList>

          <TabsContent value="details" className="space-y-6 overflow-y-auto max-h-[calc(90vh-200px)] pr-2">
          ...
          <TabsContent value="recruitment" className="overflow-y-auto max-h-[calc(90vh-200px)]">
            <PosteRecruitmentDashboard posteId={poste.id} />
          </TabsContent>
        </Tabs>
      </DialogContent>
    </Dialog>
