  ...
  const adminStructuredMenu = [
    ...
    },
    {
      ...
      items: [
       ...
       { path: '/rapprochement-ventes', label: 'Rapprochement Ventes', icon: FileText },
       { path: '/rapprochement-multi-ecritures', label: 'Rapprochement multi-écritures', icon: FileText },
