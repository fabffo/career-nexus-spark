...
import { Landmark, Mail, Phone, Globe, MapPin } from 'lucide-react';
...
interface ViewFournisseurEtatDialogProps {
  fournisseur: any;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function ViewFournisseurEtatDialog({ fournisseur, open, onOpenChange }: ViewFournisseurEtatDialogProps) {
